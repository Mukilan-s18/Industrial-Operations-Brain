...
GRAPH_FILE = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "data", "graph.json"))
...
MERGE (a)-[r:{rel_type}{props_str}]->(b);"""
    ...
    # 3. Write to file
    out_file = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "data", "neo4j_migration.cypher"))
